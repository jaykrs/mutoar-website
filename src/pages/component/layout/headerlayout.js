            ...
            <div className="col-md-6">
              <div className="top-contact">
                ...
                <div className="contacts">
                  <span><i className="fas fa-phone" /> <a href="tel:61383766284">(+61) 38376 6284</a></span>
      ...
      <div className="header-bottom">
        <div className="container">
          <nav className="navbar navbar-expand-md m-0">
            <a className="navbar-brand" href="index-2.html"><img src={headerlogo} alt="Logo" /></a>
            ...
            <div className="collapse navbar-collapse" id="main-menu">
              <ul className="navbar-nav">
                <li className="nav-item menu-item-has-children dropdown active">
                  <a className="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Demos</a>
                  <div className="dropdown-menu">
                    <a className="dropdown-item" href="index-2.html">Demo 01</a>
                ...
                <li className="nav-item menu-item-has-children dropdown">
                  ...
                  <div className="dropdown-menu">
                    <a className="dropdown-item" href="courses.html">All Courses</a>
